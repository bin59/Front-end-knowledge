...
在 iconfont 下载 svg 文件放入如：src\assets\icons\phone.svg

页面使用

```
<svg-icon name="phone" width="40px" height="40px"></svg-icon>
```
...
配置：https://github.com/vbenjs/vite-plugin-mock
...
会报错参考：https://juejin.cn/post/7237479703166959673
