...
虽然 doctype 不区分大小写，但是按照惯例，doctype 大写 （[关于 html 属性，大写还是小写](http://stackoverflow.com/questions/15594877/is-there-any-benefits-to-use-uppercase-or-lowercase-letters-with-html5-tagname)）。
...
3. 安装 sublime3 [Package Control](https://packagecontrol.io/installation#st3)
...
5. 插件的配置文件
   ...
   - ```
     ...
     注意：全局变量需要手动加到配置文件的 globals 属性里，例：
...
6. 编辑器及插件设置
   ...
   - `sublime3` 自身
     ...
     点击右下角的 Spaces->Convert Indentation to Spaces 可以将文件中的所有 tab 转换成空格
